<template>
  <div>
    ...
    <footer class="footer">
      <div class="row">
        <div class="col-12 col-lg-6 mb-3 mb-lg-0 cnvos-col">
          ...
          <div class="text-center social-col">
            <a
              href="https://www.facebook.com/cnvos?locale=sl_SI"
              target="_blank"
              rel="noopener"
              class="social-link"
            >
            ...
            <a
              href="https://www.instagram.com/nevladniki/"
              target="_blank"
              rel="noopener"
              class="social-link"
            >
