...
def migrate_string_to_int(apps, schema_editor):
    ...
    for org in Organization.objects.all():
        old_value = org.avg_revenue
        try:
            new_value = int(old_value)
            print("string_to_int success >", old_value, new_value)
        except:
            new_value = 0
            print("string_to_int fail >", old_value, new_value)
        org.avg_revenue = new_value
        org.save()


class Migration(migrations.Migration):

    dependencies = [("home", "0025_auto_20191001_1742")]
