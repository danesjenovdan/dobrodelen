    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="", max_length=512, verbose_name="Ime in priimek"
                    ),
                ),
                (
                    "role",
        ...
        migrations.AddField(
            ...
            field=models.FileField(
                blank=True, null=True, upload_to="", verbose_name="revidirano poročilo"
            ),
        ),
        migrations.AddField(
            model_name="organization",
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True,
                default="",
                verbose_name="Kontakt: (ime in priimek, e-pošta, telefon)",
            ),
        ),
        migrations.AddField(
            model_name="organization",
        ...
        migrations.AddField(
            ...
            name="finance_report",
            field=models.FileField(
                blank=True, null=True, upload_to="", verbose_name="Finančno poročilo"
            ),
        ),
        migrations.AddField(
            model_name="organization",
        ...
        migrations.AddField(
            ...
            name="given_loan",
            field=models.FileField(
                blank=True, null=True, upload_to="", verbose_name="seznam danih posojil"
            ),
        ),
        migrations.AddField(
            model_name="organization",
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True,
                default="",
                verbose_name="Poslanstvo organizacije (do 500 znakov)",
            ),
        ),
        migrations.AddField(
            model_name="organization",
        ...
        migrations.AddField(
            ...
            name="tax_number",
            field=models.CharField(
                blank=True, default="", max_length=32, verbose_name="davčna številka"
            ),
        ),
        migrations.AddField(
            model_name="organization",
        ...
        migrations.AddField(
            ...
            field=models.URLField(
                blank=True, default="", max_length=512, verbose_name="spletna stran"
            ),
        ),
        migrations.AddField(
            model_name="organization",
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True,
                default="",
                verbose_name="kratek opis organizacije (do 1500 znakov)",
            ),
        ),
        migrations.AlterField(
            model_name="organization",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        verbose_name="Ali za svoje delo v odboru prejema nadomestilo",
                    ),
                ),
                (
                    "board",
