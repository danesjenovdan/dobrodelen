...
class Criteria(models.Model):
    ...
    control_of_business_3 = models.IntegerField(
        default=0, verbose_name="odstotek neodvisnih članov z glasovalno pravico"
    )
    control_of_business_4 = models.IntegerField(
        default=0, verbose_name="organizacija ima zapisnike sej"
    )

    strategic_planning_2_1 = models.IntegerField(
        default=0, verbose_name="organizacija ima strateški načrt"
    )
    strategic_planning_2_2 = models.IntegerField(
        default=0, verbose_name="organizacija spremlja doseganje strateškega načrta"
    )
    ...
    financial_management_3_1 = models.IntegerField(
        default=0, verbose_name="odstotek sredstev, ki jih porabi za izvedbo programa"
    )
    ...
    financial_management_3_4_1 = models.IntegerField(
        default=0, verbose_name="viri sredstev"
    )
    financial_management_3_4_2 = models.IntegerField(
        default=0, verbose_name="delež prihodkov iz navečjega posameznega vira"
    )
    financial_management_3_5_1 = models.IntegerField(
        default=0, verbose_name="organizacija daje posojila povezanim osebam"
    )
    financial_management_3_5_2 = models.IntegerField(
        default=0, verbose_name="organizacija prejema posojila od povezanih oseb"
    )
    ...
    transparency_of_organizations_4_1 = models.IntegerField(
        default=0, verbose_name="organizacija ima objavljena letna poročila o delu"
    )
    transparency_of_organizations_4_2 = models.IntegerField(
        default=0, verbose_name="letna poročila o delu so razumljiva"
    )
    transparency_of_organizations_4_2_1 = models.IntegerField(
        default=0, verbose_name="organizacija ima objavljena letna finančna poročila"
    )
    transparency_of_organizations_4_2_2 = models.IntegerField(
        default=0, verbose_name="finančna poročila so razumljiva"
    )
    ...
    transparency_of_organizations_4_3 = models.IntegerField(
        default=0, verbose_name="Objavljene so plače vodstva"
    )
    transparency_of_organizations_4_4 = models.IntegerField(
        default=0, verbose_name="objavljeno je razmerje med plačami"
    )
    transparency_of_organizations_4_5 = models.IntegerField(
        default=0, verbose_name="objavljen je seznam ključnih zaposlenih"
    )
    transparency_of_organizations_4_6 = models.IntegerField(
        default=0, verbose_name="obljavljeni so člani nadzornega/upravnega odbora"
    )
    transparency_of_organizations_4_7 = models.IntegerField(
        default=0, verbose_name="objavljen je finančni načrt za tekoče leto"
    )
